...
hfh = h.hfh
pd = h.pd
from core.h_report_analysis import create_all
...
def procees_karen_data(data_path, processed_data_path, report_path, test_bank_string, data_string, report_name, xCalibre_path):
    ...
    #5  process xCalibre files and create Stats_c files
    #6  create aggregate reports from _Stats_c files
    create_all(xCalibre_report=xCalibre_path, aggregate_report_path=report_path, report_name=report_name)
...
data_path = "LCLE_IRT/data"
processed_data_path = "LCLE_IRT/processed_data"
report_path = "LCLE_IRT/reports"
test_bank_string = "Test"
data_string = "FullAdmin"
report_name = "_LCLE_"
xCalibre_path = "LCLE_IRT/xCalibreOutput"
procees_karen_data(processed_data_path=processed_data_path, report_path=report_path, data_string=data_string, data_path=data_path,
                  report_name=report_name, xCalibre_path=xCalibre_path, test_bank_string=test_bank_string)
